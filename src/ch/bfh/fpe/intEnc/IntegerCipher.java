 ...
 * 
 * Currently the only implemented IntegerCipher in this package is the FFXCipher who can handle numbers from zero to a maximum of 38 decimal digits (128 bits).<br>
